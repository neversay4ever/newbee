    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strain_id', models.CharField(max_length=50, verbose_name='菌株编号')),
                ('strain_genome_sequence', models.CharField(blank=True, max_length=50, null=True, verbose_name='是否检测细菌基因组')),
                ('strain_genome_seq_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='细菌基因组测序编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isolation_culture_temperature_centigrade', models.CharField(blank=True, max_length=50, null=True, verbose_name='菌株分离培养温度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mapped_sequence_16s', models.CharField(blank=True, max_length=50, null=True, verbose_name='16S比对到的序列')),
                ('similarity_16s', models.CharField(blank=True, max_length=50, null=True, verbose_name='16S比对相似度')),
                ('blast_website_16s', models.CharField(blank=True, max_length=50, null=True, verbose_name='16S比对网站')),
                ('data_file_path_16s', models.CharField(blank=True, max_length=50, null=True, verbose_name='16S序列存储位置')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strain_storage_solution', models.CharField(blank=True, max_length=50, null=True, verbose_name='菌株存储液')),
                ('strain_storage_temperature_centigrade', models.CharField(blank=True, max_length=50, null=True, verbose_name='菌株存储温度')),
                ('strain_storage_location', models.CharField(blank=True, max_length=50, null=True, verbose_name='菌株存储地点')),
                ('strain_storage_date', models.DateField(blank=True, null=True, verbose_name='菌株存储时间')),
            ],
            options={
                'verbose_name': '菌株存储信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('strain_id', models.CharField(max_length=50, verbose_name='菌株编号')),
                ('bee_host_species', models.CharField(blank=True, max_length=50, null=True, verbose_name='蜜粉宿主物种')),
                ('exact_site', models.CharField(blank=True, max_length=50, null=True, verbose_name='采集地简要信息')),
                ('bee_host_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='蜜粉宿主标本编号')),
